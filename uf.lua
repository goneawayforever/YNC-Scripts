...
MainSection:NewButton("NoclipGui", "Gui", function()
--[[
...
MainSection:NewToggle("LeaveWhenAdminJoins", "ReadBro?", function(state)
    if state then
    print("ToggleOn")
    else
   print("ToggleOff")
...
-- Script
MainSection:NewButton("INF YEILD", "GUI", function()
...
Script() -- call the script immediately
