...
local scriptURL = 'https://pastebin.com/raw/e89Mn4Ec'
        ...
        if executeScript then
            ...
            warn("Failed to load the script from Pastebin.")
        end
...
task.spawn(function()
	chat("my skills are certified now.")
	wait(0.1)
	chat(".͟g͟g͟/͟y͟n͟c͟s͟c͟r͟i͟p͟t͟s͟ on blue app for skills!" .. prefix .. "")
end)

task.spawn(function()
	while wait(300000) do
		if disconnected == false then
			chat("my hands are sigma now" .. prefix .. "")
		end
	end
end)
